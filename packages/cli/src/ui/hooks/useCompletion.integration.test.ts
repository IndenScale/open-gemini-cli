...
import { Config, FileDiscoveryService } from '@indenscale/open-gemini-cli-core';
...
// Mock dependencies
vi.mock('fs/promises');
vi.mock('@indenscale/open-gemini-cli-core', async () => {
  const actual = await vi.importActual('@indenscale/open-gemini-cli-core');
  return {
    ...actual,
