...
// Mock @indenscale/open-gemini-cli-core and its Config class
vi.mock('@indenscale/open-gemini-cli-core', async (importOriginal) => {
  const actualCore =
    await importOriginal<typeof import('@indenscale/open-gemini-cli-core')>();
